...
# Score text
score_font = pygame.font.Font('atividade004/assets/PressStart2P.ttf', 44)
score_text = score_font.render('00 x 00', True, COLOR_WHITE, COLOR_BLACK)
score_text_rect = score_text.get_rect(center=(680, 50))

# Victory text
victory_font = pygame.font.Font('atividade004/assets/PressStart2P.ttf', 100)
victory_text = victory_font.render('VITORIA', True, COLOR_WHITE, COLOR_BLACK)
victory_text_rect = victory_text.get_rect(center=(640, 350))  # Center of screen

# Sound effects
bounce_sound_effect = pygame.mixer.Sound('atividade004/assets/bounce.wav')
scoring_sound_effect = pygame.mixer.Sound('atividade004/assets/258020__kodack__arcade-bleep-sound.wav')

# Player 1
player_1 = pygame.image.load("atividade004/assets/player.png")
player_1_y = 300
player_1_move_up = False
player_1_move_down = False

# Player 2 - robot
player_2 = pygame.image.load("atividade004/assets/player.png")
player_2_y = 300

# Ball
ball = pygame.image.load("atividade004/assets/ball.png")
ball_x = 640
ball_y = 360
ball_speed = 7
...
while game_loop:
    ...
    if score_1 < SCORE_MAX and score_2 < SCORE_MAX:
        ...
        if ball_rect.colliderect(player_1_rect) and ball_dx < 0:
            ...
            ball_speed = min(ball_speed * 1.1, 16)  # Increase speed by 10%, cap at 16
        ...
        if score_1 >= SCORE_MAX:
            ...
            defeat_text = defeat_font.render('DERROTA', True, COLOR_WHITE, COLOR_BLACK)
            defeat_text_rect = defeat_text.get_rect(center=(640, 350))
